...
export const DEFAULT_ORG_GROUPS: DefaultOrgGroup[] = [
  {
    ...
    units: [
      ...
      },
      {
        ...
        locationAliases: ["Bony Maneshar", "Manesar", "Maneshar"],
        kpiPlantAliases: ["Bony Maneshar"],
      ...
      },
      {
        ...
        locationAliases: ["Bony Haridwar 2", "Haridwar 2"],
        kpiPlantAliases: ["Bony Haridwar 2"],
  ...
  },
  {
    ...
    units: [
      ...
      },
      {
        ...
        locationAliases: ["Saket Fabs Coating", "SF-2", "SF2"],
        kpiPlantAliases: ["Saket Fabs Coating", "SF-2"],
      ...
      },
      {
        ...
        locationAliases: ["Saket Fabs Haridwar", "SF-3", "SF3"],
        kpiPlantAliases: ["Saket Fabs Haridwar", "SF-3"],
      ...
      },
      {
        ...
        locationAliases: ["Saket Fabs Gujrat", "SF-4", "SF4"],
        kpiPlantAliases: ["Saket Fabs Gujrat", "SF-4"],
...
export const DEFAULT_STANDALONE_UNITS: DefaultOrgUnit[] = [
  {
    ...
    locationAliases: [
      ...
      "58",
      "BF 58",
      "BONY FLUID SYSTEMS PVT. LTD.",
      "37P & 58",
    ],
    kpiPlantAliases: ["Bony Fluid 58", "Plant 58", "Plant 58P"],
    gradientCss: "linear-gradient(135deg, #0891b2 0%, #14b8a6 50%, #10b981 100%)",
    accent: "text-cyan-600",
    emoji: "💧",
    sortOrder: 0,
